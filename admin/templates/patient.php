            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor" style="color: rgb(218,5,5)"><b>Archives des patients</b></h4>
                    </div>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <form action="" method="POST">
                        <div class="modal-body">
                            ...
                            <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label text-primary">Telephone</label>
                                <div class="col-sm-10">
                                <input name="tel" type="text" class="form-control" placeholder="Entrer le numéro telephone">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label text-primary">Couverture social</label>
                                <div class="col-sm-10">
                                <input name="couverture" type="text" class="form-control" placeholder="Entrer le genre du couverture social">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-2 col-form-label text-primary">Informations</label> 
                                <div class="col-sm-10">
                                <textarea name="infos" class="form-control" placeholder="Entrer les informations"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">COUVERTURE SOCIALE</th>
                                            <th class="text-center">DATE INSCRIPTION</th>
                                            <th class="text-center">InformationsSurEtatDeSantéPatient</th>
                                    ...
                                    <?php  $nbLignes = $dossierPatient->rowCount();
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $reponses->date_naissance; ?></td>
                                            <td class="text-center"><?php echo $reponses->couverture_patient; ?></td>
                                            <td class="text-center"><?php echo $reponses->date_inscription; ?></td>
                                            <td class="text-center"><?php echo $reponses->infos; ?></td>
                                            <td class="txt-oflo"><a class="text-primary" href="admin.php?page=modify&action=edit_patient&dossier_patient=<?php echo $reponses->dossier_patient ?>"><i class="fa fa-edit"></i>Modifier</a></td>
                                            <td class="txt-oflo"><a class="text-danger" href="" onclick="event.preventDefault();confirm('êtes-vous sur que vous voulez supprimer?') && window.location.replace('admin.php?page=patient&action=delete&dossier_patient=<?php echo $reponses->dossier_patient ?>')"><i class="fa fa-trash-o"></i></span>Supprimer</a></td>
                                            <td class="txt-oflo"><a class="text-info" href="" onclick="event.preventDefault();window.location.replace('admin.php?page=patient&action=rapport&dossier_patient=<?php echo $reponses->dossier_patient ?>')"><i class="fa fa-folder-open-o"></i></span>rapport</a></td>
                                        </tr>
                                        <?php } ?>
                                    <?php } ?>
                                    </tbody>

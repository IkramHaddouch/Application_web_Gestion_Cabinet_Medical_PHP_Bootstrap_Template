            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor" style="color: rgb(218,5,5)"><b>Archives des rendez-vous</b></h4>
                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 style="font-size:25px;" class="modal-title text-primary" id="exampleModalLabel">Ajouter un rendez-vous</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form action="" method="POST">
                        <div class="modal-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input name="date" type="text" class="form-control" placeholder="Entrer la date">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <?php  $nbLignes = $dossierPatient->rowCount();
                                        ...
                                        <tr>
                                            ...
                                            <td class="txt-oflo"><a class="text-primary" href="admin.php?page=modify&action=edit_rendez-vous&id=<?php echo $reponses->id ?>"><i class="fa fa-edit"></i>Modifier</a></td>
                                            <td class="txt-oflo"><a class="text-danger" href="" onclick="event.preventDefault();confirm('êtes-vous sur que vous voulez supprimer?') && window.location.replace('admin.php?page=rendez-vous&action=supprimer&id=<?php echo $reponses->id ?>')"><i class="fa fa-trash-o"></i></span>Supprimer</a></td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        ...
                                        <?php while($reponses=$datePatient->fetch(PDO::FETCH_OBJ)): ?>
                                            ...
                                            <td class="text-center"><?php echo $reponses->couverture_patient; ?></td>
                                            <td class="txt-oflo"><a class="text-primary" href="admin.php?page=modify&action=edit_rendez-vous&id=<?php echo $reponses->id ?>"><i class="fa fa-edit"></i>Modifier</a></td>
                                            <td class="txt-oflo"><a class="text-danger" href="" onclick="event.preventDefault();confirm('êtes-vous sur que vous voulez supprimer?') && window.location.replace('admin.php?page=rendez-vous&action=delete&id=<?php echo $reponses->id ?>')"><i class="fa fa-trash-o"></i>Supprimer</a></td>
